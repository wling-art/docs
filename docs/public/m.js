...
`, 'color:white;background-color:#660099', '')
    ...
    // ZLNetwork
    setTimeout(
        Log.bind(console, `%c ZLNetwork-1 %c 已连接到 ZL钟乐 网络!`, 'color:white;background-color:#87ceeb', '')
        , 1000)
    setTimeout(
    ...
    setTimeout(
        ...
        , 1020)
    setTimeout(
        Log.bind(console, `%c ZLNetwork-4 %c 已从 ZL钟乐 网络断开!`, 'color:white;background-color:#87ceeb', '')
        , 10000)
});